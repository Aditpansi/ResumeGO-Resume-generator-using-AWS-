...
?>
    ...
    <head>
        ...
        <style>
            .btn {
                ...
                background-color: rgb(12, 153, 248);
                color: white;
                border: 0px;
                border-radius: 10px;
                cursor: pointer;
    ...
    <body>
        ...
        <a href="#" onclick="printResume()" class="printBtn" style="color:black"> <button class="btn btn-primary">Print</button></a>
      ...
      ?>
            ...
            <div class="zone-2">
                <div class="headTitle">
                    <h1>
                        <?php echo ucwords($first_name);?><br><b><?php echo ucwords($last_name);?></b></h1>
                </div>
                <div class="subTitle">
                    <h1>
